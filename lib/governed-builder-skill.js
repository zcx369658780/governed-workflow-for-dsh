...
//#region src/governed-builder-skill.ts
/** The single public governed-builder skill name. */
const GOVERNED_BUILDER_SKILL_NAME = "governed-builder";
/** The runtime-registered governed-builder skill contribution. */
const governedBuilderSkill = {
	...
	content: `# Governed Builder operating procedure
...
*/
var GovernedBuilderSkill = class extends Service {
...
//#endregion
export { GOVERNED_BUILDER_SKILL_NAME, GovernedBuilderSkill, GovernedBuilderSkill as default, governedBuilderSkill };
